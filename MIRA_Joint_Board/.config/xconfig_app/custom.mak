...
linker.cmd: package/cfg/app_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/app_pem4fcfg.cmd\)\"$""\"C:/Users/Ben/Documents/MQP_Code/MIRA_Joint_Board_Code/MIRA_Joint_Board/.config/xconfig_app/\1\""' package/cfg/app_pem4f.xdl > $@
