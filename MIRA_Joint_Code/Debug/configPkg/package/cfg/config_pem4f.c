...
const __T1_xdc_runtime_Text_charTab xdc_runtime_Text_charTab__A[6333];
...
__FAR__ const CT__xdc_runtime_Text_charCnt xdc_runtime_Text_charCnt__C = (xdc_Int16)0x18bd;
