...
__obj = [
    ...
    {},    // #720 ti.sysbios.knl.Task.Instance#2
    {},    // #721 ti.sysbios.knl.Task.Instance#2/instance
...
__o = __obj[720]  // ti.sysbios.knl.Task.Instance#2
    __o['$category'] = String(java.net.URLDecoder.decode('Instance', 'UTF-8'))
    __o['$module'] = __obj[714.0]
...
__o = __obj[721]  // ti.sysbios.knl.Task.Instance#2/instance
    __o['$category'] = String(java.net.URLDecoder.decode('Struct', 'UTF-8'))
