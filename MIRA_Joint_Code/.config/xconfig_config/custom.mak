...
linker.cmd: package/cfg/config_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/config_pem4fcfg.cmd\)\"$""\"C:/Users/Ben/Documents/MQP_Code/MIRA_Joint_Board_Code/MIRA_Joint_Code/.config/xconfig_config/\1\""' package/cfg/config_pem4f.xdl > $@
